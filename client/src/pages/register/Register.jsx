            ...
            <div className="h-screen md:flex">
                ...
                <div
                    ...
                    <div>
                        ...
                        <h1 className="text-white font-bold text-4xl font-sans"><a href='/'> <span className=' text-sky-500'>BI</span>NOTE</a></h1>
                ...
                <div className="flex md:w-1/2 justify-center py-10 items-center bg-nejoinwhite">

                    <form className="bg-white">
                        <h1 className="text-gray-800 font-bold text-2xl mb-1">Merhaba</h1>
                        <p className="text-sm font-normal text-gray-600 mb-7">Tekrar Hoş Geldin</p>
